/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: 5b86a36caafa00ec31d57f052abf2c90)
...
interface __BaseEnv_Env {
	...
	CloudOpsAgent: DurableObjectNamespace<import("./src/server").CloudOpsAgent>;
	INCIDENT_WORKFLOW: Workflow<Parameters<import("./src/server").IncidentInvestigationWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "ChatAgent" | "CloudOpsAgent";
	}
